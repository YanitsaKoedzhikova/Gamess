...
class __TwigTemplate_6be526a148bd662df1bd7369f23087effcb6108f6ef19176a00090272773b2fa extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/freelancer_zymphonies_theme/templates/content-edit/filter-tips.html.twig", "C:\\xampp\\htdocs\\Gamess\\web\\themes\\contrib\\freelancer_zymphonies_theme\\templates\\content-edit\\filter-tips.html.twig");
    }
